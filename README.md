...
2. From the `web/` directory run `npm install` followed by `npm run dev`.
3. Deploy through Vercel; configure Supabase and odds provider environment variables in project settings.
